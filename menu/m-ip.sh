...
data_ip="https://raw.githubusercontent.com/UnderTunnel/permission/main/seler"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/UnderTunnel/permission/main/"
...
REPO="https://github.com/UnderTunnel/permission.git"
...
#edit link https://justpaste.it/edit/62611923/jvkpgifwvqum13le
    ...
    git remote add origin https://github.com/UnderTunnel/permission
    git push -f https://${TOKEN}@github.com/UnderTunnel/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
