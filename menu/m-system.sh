...
sldns() {
wget https://raw.githubusercontent.com/UnderTunnel/autoscript/main/slowdns/ && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget https://raw.githubusercontent.com/UnderTunnel/autoscript/main/slowdns/ && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/UnderTunnel/autoscript/main/slowdns/ && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/UnderTunnel/autoscript/main/slowdns/ && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/User058/vip/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
