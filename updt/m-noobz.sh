...
if [ ! -e /etc/xray/noobz/USER ]; then
mkdir -p /etc/xray/noobz/USER
fi
function create(){
clear
...
TEXT2="
<code>◇━━━━━━━━━━━━━━◇</code>
<code>   TRANSAKSI NOOBZVPNS Success </code>
<code>◇━━━━━━━━━━━━━━◇</code>
...
<code>◇━━━━━━━━━━━━━━◇</code>
<i>AutoNotif Create USER From Server..</i>"
curl -s --max-time $TIMES -d "chat_id=$CHATID2&disable_web_page_preview=1&text=$TEXT2&parse_mode=html" $URL2 >/dev/null
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "NOOBZVPN ACCOUNT" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "DOMAIN : $( cat /etc/xray/domain )" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "USERNAME: $USER" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "PASSWORD: $pass" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "IP LIMIT: $ip" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "EXP DAYS: EXP DAYS : $expi ( $exp Days )" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "tcp_std port:  8080" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "tcp_ssl port: 8443" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "Example config TCP_STD 8080" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo "" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "$config80" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo "" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "Example config TCP_SSL 8443" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo "" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "$config443" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo "" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e " • TUNNEL STORES •" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
echo -e "◇━━━━━━━━━━━━━━━━━◇" | tee -a /etc/xray/noobz/USER/log-create-${USER}.log
...
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ $NC  ${WH}[${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}ADD USER${NC}      ${WH}[${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}DELETE USER${NC}   $COLOR1 $NC"
echo -e "$COLOR1│ $NC  ${WH}[${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}SHOW USER${NC}     ${WH}[${COLOR1}05${WH}]${NC} ${COLOR1}• ${WH}LOCKED USER${NC}    $COLOR1 $NC"
echo -e "$COLOR1│ $NC  ${WH}[${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}RENEW USER${NC}    ${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}UNLOCKED USER${NC}    $COLOR1 $NC"
