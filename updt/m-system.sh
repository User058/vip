...
echo -e "${COLOR1}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e ""
echo -e " ${WH}[${COLOR1}•1${WH}]${NC} ${COLOR1} Total Bandwith"
echo -e " ${WH}[${COLOR1}•2${WH}]${NC} ${COLOR1} See Bandwith last 5 minutes "
echo -e " ${WH}[${COLOR1}•3${WH}]${NC} ${COLOR1} Hourly Usage Table"
echo -e " ${WH}[${COLOR1}•4${WH}]${NC} ${COLOR1} Daily Usage Table"
echo -e " ${WH}[${COLOR1}•5${WH}]${NC} ${COLOR1} Tabel Penggunaan Setiap Bulan"
echo -e " ${WH}[${COLOR1}•6${WH}]${NC} ${COLOR1} Monthly Usage Table"
echo -e " ${WH}[${COLOR1}•7${WH}]${NC} ${COLOR1} Highest Usage"
echo -e " ${WH}[${COLOR1}•8${WH}]${NC} ${COLOR1} Hourly Usage Statistics"
echo -e " ${WH}[${COLOR1}•9${WH}]${NC} ${COLOR1} View Current Active Usage"
echo -e " ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1} View Current Active Usage Traffic [5s]"
echo -e ""
echo -e " [\e[31m•0${WH}]${NC} ${COLOR1} \e[31mBACK TO MENU${NC}"
echo -e " [\e[31m•x${WH}]${NC} ${COLOR1} Exit"
echo -e ""
echo -e "${COLOR1}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e ""
