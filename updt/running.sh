...
Exp=$(curl -sS https://raw.githubusercontent.com/User058/vip/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
# DNS PATCH
#tipeos2=$(uname -m)
Name2=$(curl -sS https://raw.githubusercontent.com/User058/vip/main/ip | grep $MYIP | awk '{print $2}')
# GETTING DOMAIN NAME
